...
Object.extend(lively.ide.commands.byName, {
    ...
    'lively.ide.openSubserverViewer': {description: 'open SubserverViewer', isActive: lively.ide.commands.helper.noCodeEditorActive, exec: function(subserverToBrowse) { $world.openSubserverViewer(subserverToBrowse && function(err, viewer) { viewer.browse(subserverToBrowse); }); return true; }},
